...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(Constants.PATH_LOGIN, Constants.PATH_REGISTRATION).permitAll()
                .antMatchers(Constants.PATH_PUBLIC).permitAll()
                .antMatchers(Constants.PATH_PRIVATE).hasRole(Constants.ADMIN_ROLE)
